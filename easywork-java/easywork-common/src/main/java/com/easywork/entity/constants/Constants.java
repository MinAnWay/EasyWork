package com.easywork.entity.constants;
...
public class Constants {
    ...
    public static final String[] EXCEL_TITLE_QUESTION = {"标题", "分类名称", "难度", "问题描述", "答案分析"};

    public static final String[] EXCEL_TITLE_EXAM_QUESTION = {"标题", "分类名称", "难度", "问题类型", "问题答案", "问题描述", "答案分析"};
    ...
    public static final String REDIS_KEY_CHECKCODE = "easywork:check";

    public static final String JWT_KEY_LOGIN_TOKEN = "jwt_login_token_key";

    public static final Integer JWT_TOKEN_EXPIRE_DAYS = 7;
