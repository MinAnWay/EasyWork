...
public enum PermissionCodeEnum {
    ...
    CATEGORY_DEL("category_delete", "删除"),
    ...
    QUESTION_DEL("question_delete", "删除"),
    QUESTION_DEL_BATCH("question_delete_batch", "批量删除"),
    ...
    SHARE_DEL("share_delete", "删除"),
    SHARE_DEL_BATCH("share_delete_batch", "批量删除"),

    APP_UPDATE_LIST("app_update_list", "应用发布列表"),
    APP_UPDATE_EDIT("app_update_edit", "应用发布新增/修改"),
    APP_UPDATE_POST("app_update_post", "应用发布"),

    APP_CAROUSEL_LIST("app_carousel_list", "轮播图列表"),
    APP_CAROUSEL_EDIT("app_carousel_edit", "轮播图新增/修改"),
    ...
    APP_USER_DEVICE("app_user_device", "APP用户设备");
